...
<body>
  <div id="app">
    <section class="section">
      ...
      <div class="row" style="background-color: #D7FFE3">
      
        <div class="col-lg-4 col-md-6 col-12 col-sm-7 order-lg-1 min-vh-100 order-1 bg-white">
          <div class="p-4 m-3">
        ...
        <div class="col-lg-8 col-md-6 col-sm-5 order-1 text-center" style="margin-top: 120px;">
            <h4>Apotek Karya Husada Farma</h4>
