                            ...
                            <form action="<?= base_url('/admin/uaksiobat'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kd_sup" class="form-control <?= ($validation->hasError('id_sup') ? 'is-invalid' : ''); ?>" required>
                                        ...
                                        <?php foreach ($dsuplier as $dsuplier) { ?>
                                            <option value="<?= $dsuplier['kd_sup']; ?>" <?php if ($dsuplier['kd_sup'] == $dobat->kd_sup) {
                                                                                            echo "selected";
                                                                                        } ?>><?= $dsuplier['nama']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_s" class="form-control <?= ($validation->hasError('id_s') ? 'is-invalid' : ''); ?>" required>
                                        ...
                                        <?php foreach ($dsatuan as $dsatuan) { ?>
                                            <option value="<?= $dsatuan['id_s']; ?>" <?php if ($dsatuan['id_s'] == $dobat->id_s) {
                                                                                            echo "selected";
                                                                                        } ?>><?= $dsatuan['satuan']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_k" class="form-control <?= ($validation->hasError('id_k') ? 'is-invalid' : ''); ?>" required>
                                        ...
                                        <?php foreach ($dkategori as $dkategori) { ?>
                                            <option value="<?= $dkategori['id_k']; ?>" <?php if ($dkategori['id_k'] == $dobat->id_k) {
                                                                                            echo "selected";
                                                                                        } ?>><?= $dkategori['kategori']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="harga_beli" value="<?= $dobat->harga_beli; ?>" class="form-control <?= ($validation->hasError('harga_beli') ? 'is-invalid' : ''); ?>" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="harga_jual" value="<?= $dobat->harga_jual; ?>" class="form-control <?= ($validation->hasError('harga_jual') ? 'is-invalid' : ''); ?>" required>
                                        <div class="invalid-feedback">
