...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Data Obat Yang Akan Kadaluwarsa</h1>
                ...
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-dark">Obat yang akan kadaluwarsa</h4>
                        </div>
                        <div class="card-body">
                            <div class="alert alert-warning alert-has-icon">
                                ...
                                <div class="alert-body">
                                    ...
                                    Obat yang akan masuk kadaluarsa.
                                </div>
                            </div>
                            <table class="table table-striped table-bordered tbl" width="100%">
                                ...
                                <tbody>
                                    <?php foreach ($dobat as $obat) {
                                        ...
                                        if (date('Y-m-d', time() + (60 * 60 * 13)) >= $pengurangan && date('Y-m-d', time() + (60 * 60 * 13)) <= $obat['tgl_kadaluarsa']) {
                                    ?>
                                            <tr>
                                                <td><?= $obat['nm_obat'] ?></td>
                                                <td><?= $obat['nama'] ?></td>
