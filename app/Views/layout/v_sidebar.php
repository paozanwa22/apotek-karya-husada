  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      ?>
        ...
        <li class="<?= ($uri->uri->getSegment('2') == '') ? 'active' : ''; ?>"><a class="nav-link" href="<?= base_url('admin'); ?>"><i class="fas fa-tachometer-alt"></i> <span>Beranda</span></a>
        </li>
        ...
        <li class="nav-item dropdown <?= ($uri->uri->getSegment('2') == 'dpenjualan') || ($uri->uri->getSegment('2') == 'dpembelian') ? 'active' : '' ?>">
        ...
        <li class="<?= ($uri->uri->getSegment('2') == 'laporan') ? 'active' : ''; ?>"><a href="<?= base_url(); ?>/laporan/laporan" class="nav-link"><i class="fas fa-file-alt"></i>
            <span>Laporan</span></a>
        </li>

        <li class="menu-header">Akun</li>
        <li class="<?= ($uri->uri->getSegment('2') == 'dpengguna') ? 'active' : ''; ?>"><a href="<?= base_url(); ?>/admin/dpengguna" class="nav-link"><i class="fas fa-users"></i>
            <span>Pengguna</span></a></li>

        <li class="menu-header">pengaturan</li>
        <li class="<?= ($uri->uri->getSegment('2') == 'profile_aptk') ? 'active' : ''; ?>"><a href="<?= base_url(); ?>/admin/profile_aptk" class="nav-link"><i class="fas fa-user"></i> <span>Profile
              Apotek</span></a>
        </li>
      ...
      ?>
        ...
        <li class="<?= ($uri->uri->getSegment('2') == 'laporan') ? 'active' : ''; ?>"><a href="<?= base_url(); ?>/admin/laporan" class="nav-link"><i class="fas fa-file-alt"></i>
            <span>Laporan</span></a>
        </li>
