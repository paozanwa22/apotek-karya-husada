...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2021 at 08:39 AM
...
('KDOB0002', 'Hansaplast princess Isi 10', 'SUP0025', 7, 5, '5500', '9000', 77, '2022-12-01'),
('KDOB0003', 'Hansaplast Roll Kain 1,25x5M', 'SUP0025', 7, 5, '6000', '10000', 44, '2022-11-01'),
('KDOB0004', 'Nivea Deo Invisible 50', 'SUP0024', 7, 5, '13500', '18000', 60, '2023-06-22'),
...
('KDOB0009', 'Theraskin Serum Vit C plus', 'SUP0007', 6, 7, '45000', '60000', 13, '2023-11-12'),
('KDOB0010', 'Theraskin deo lotion 20ml', 'SUP0007', 6, 7, '12500', '16000', 21, '2023-10-03'),
('KDOB0011', 'Theraskin AHA 10 Cream 10gr', 'SUP0007', 14, 7, '17000', '25000', 50, '2022-10-11'),
('KDOB0012', 'Tremenza Syrup', 'SUP0008', 6, 4, '21000', '25000', 11, '2022-06-19'),
('KDOB0013', 'Valproic Acid Syrup', 'SUP0010', 6, 4, '50600', '70500', 13, '2021-10-06');
...
(50, '300920210007', 'SUP0007', 181, '2021-09-30', 'Theraskin AHA 10 Cream 10gr', 17000, 50, 850000),
(51, '300920210007', 'SUP0007', 181, '2021-09-30', 'Theraskin deo lotion 20ml', 12500, 20, 250000);
...
(17, 'Yudika', 'apoteker@gmail.com', '-', '$2y$10$gkXh/z7/WJ6oAtBJIWl7bO9fRShl8FzjQ2ttKFTALxZAALvAUdTZ.', '-', '2021-09-30', 'default.png', 'Apoteker', '-');
...
(167, '300920210007', 'KDOB0002', 179, '2021-09-30', 2, 18000, '20.000', '2.000'),
(168, '300920210008', 'KDOB0004', 180, '2021-09-30', 3, 54000, '60.000', '6.000');
...
--
ALTER TABLE `invoice`
  MODIFY `id_invoice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;
...
--
ALTER TABLE `tb_pembelian`
  MODIFY `id_pem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `tb_penjualan`
  MODIFY `id_pen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
